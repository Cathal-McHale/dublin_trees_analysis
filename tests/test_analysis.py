...
class TestDataLoader(unittest.TestCase):
    ...
    def test_load_tree_data(self, mock_file):
        """
        Test loading tree data from a JSON file.
        """
    ...
    def test_load_property_data(self):
        """
        Test loading and preprocessing property data from a CSV file.
        """
...
class TestPriceAnalyser(unittest.TestCase):
    """
    Test cases for the PriceAnalyser class.
    """
    def setUp(self):
        self.tree_data = {
    ...
    def test_extract_street_names(self):
        """
        Test extracting street names from tree data.
        """
    ...
    def test_compute_average_price(self):
        """
        Test computing the average property price for a set of street names.
        """
    ...
    def test_analyse(self):
        """
        Test analysing the average property prices for short and tall tree streets.
        """
